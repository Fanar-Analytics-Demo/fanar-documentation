...
1. **Your database** - Fanar passes the query AS IS and it's your database's responsibility to handle your query
...
:::info
IMPORTANT TO NOTE: The relevant size (for Fanar) is the size of the results.
