...
4. **Visualization and dashboards**: Create [beautiful visualizations](../build/visualizations/visualization-types) with drag and drop, and combine them into a single dashboard.
