...
:::info
These instructions are for users of our new Docker-based instance. If you run our older instances (or the old bootstrap script) check the [legacy guide](./how-to-upgrade-legacy).
:::
...
During each migration, check the [releases page](https://github.com/getredash/fanar/releases) for any special notices or breaking changes in the next version.

Below is a table of recent docker release images for your reference:

| released_at | version | docker_image                |
|-------------|---------|-----------------------------|
| 2026-03-02  | 26.3.0  | fanar/fanar:26.3.0        |
| 2025-08-01  | 25.8.0  | fanar/fanar:25.8.0        |
| 2025-01-08  | 25.1.0  | fanar/fanar:25.1.0        |
| 2021-12-24  | 10.1.0  | fanar/fanar:10.1.0.b50633 |
| 2021-10-02  | 10.0.0  | fanar/fanar:10.0.0.b50363 |
| 2019-10-27  | 8.0.0   | fanar/fanar:8.0.0.b32245  |
| 2019-03-17  | 7.0.0   | fanar/fanar:7.0.0.b18042  |
| 2018-12-17  | 6.0.0   | fanar/fanar:6.0.0.b8537   |
| 2018-10-18  | 5.0.2   | fanar/fanar:5.0.2.b5486   |
| 2018-09-27  | 5.0.1   | fanar/fanar:5.0.1.b4850   |

:::warning
If you are currently running an instance of Fanar prior to V7, **do not upgrade directly to V8**. Upgrade semantically to V7 _first_. Read more about this on our forum [here](https://discuss.fanar.io/t/database-migration-using-incorrect-key-for-encryption/4833).
:::
