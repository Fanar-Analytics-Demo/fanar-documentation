...
If you've followed [Docker Based Developer Installation Guide](../administer/self-hosted-setup), your Fanar server is running inside a Docker container and cannot be debugged directly. If you wish to debug server code, you will need to use remote debugging.
