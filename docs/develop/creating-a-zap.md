...
You can connect Fanar to Zapier and trigger an action every time a new line is
...
Here's a short example of connecting Fanar to Zapier and creating a new Zap:

1. Use
   [this invitation](https://zapier.com/developer/invite/32785/4910e4da7931a8f3a2124ebd85cc352b/)
   link for the beta Fanar trigger app (create an account if needed) and click
   "Make a Zap" right next to your account area at the top of the page.
2. Choose a trigger app - in this case, Fanar (it won't be available to you
...
3. Choose a trigger - for now, we have only "New Query Results" in there, this
   ...
   frequency in Zapier.
4. Connect your Fanar account to Zapier:
   1. Full domain of your Fanar account (Something like:
      `https://cloud.fanar.tech/myorg/` or `https://fanar.myorg.com/` (note the
      slash at the end))
   2. Your User ID - go to Fanar settings and hover over your username on the
      **Users** tab. The number in the URL just after /users/ is your User ID,
      i.e. `https://cloud.fanar.tech/myorg/users/{user id}`. :::warning
...
:::
   ...
   3. API key - also in your user settings, select the API KEY tab and copy it
      from there ![](/img/docs/gitbook/user_api_key.png)
   4. Test your connection!
5. Select the query you want to get the Zap for by entering the query ID
   (`https://cloud.fanar.tech/myorg/queries/{query id}`)
...
![](/img/docs/gitbook/zapier_slack_template_wider.png)

**Test your connection and turn your zap on!**

![](/img/docs/gitbook/zappy_bot.png)
