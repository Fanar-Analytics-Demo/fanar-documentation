...
![](/img/docs/gitbook/atsd_user_group.png)
...
![](/img/docs/gitbook/atsd_user.png)
...
|        Metric Limit        |      5000     |    No    |                                    Maximum number of ATSD [metrics](https://github.com/axibase/atsd-docs/blob/master/api/meta/metric/list.md#query-parameters) displayed as tables in Fanar.                                    |
...
![](/img/docs/gitbook/atsd_datasource.png)
...
![](/img/docs/gitbook/atsd_query.jpg)
