...
:::danger
The Fanar ES connector was a community contribution from several years ago.
...
[here](https://github.com/getredash/fanar/pull/4391)).
:::


Fanar supports two flavors of Elasticsearch queries, Lucene/string style
...
Fanar has two data sources available for Elasticsearch. You need to use the
