...
:::info
The `$humanTime` function is also needed when using [Query Parameters](../user-guide/querying/query-parameters) of type Date or Date/Time with MongoDB, due to the difference between the format Fanar uses and the one MongoDB expects.
