...
Fanar can read CSV files and Excel spreadsheets from any accessible URL.
...
To query Excel or CSV files with SQL, you can use the [QRDS](../user-guide/querying/query-results-data-source) in a separate query.
