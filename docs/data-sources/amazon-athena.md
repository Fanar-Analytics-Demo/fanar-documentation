...
![](/img/docs/gitbook/athena_iam_console1.png)
...
![](/img/docs/gitbook/athena_iam_console2.png)
...
In Fanar, in the New Data Source page select "Athena" as the data source type
...
![](/img/docs/gitbook/athena_data_source.png)
