...
Starting from Fanar version `8-beta.2` we will give you an option to share anonymous aggregated
usage data when Fanar does a version check. This is opt-in, but we encourage you to join as it
