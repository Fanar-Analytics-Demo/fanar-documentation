...
1. Register your instance of Fanar with your Google org by visiting the [cloud console](https://console.cloud.google.com/apis/credentials). You must [create a developers project](../google-developer-account-setup) if you have not already. Then follow the **Create Credentials** flow.
...
is: `https://cloud.fanar.tech/org-slug/saml/callback`
...
3. In the SAML2 config set up the callback URL:
   - For SaaS customers, the URL is:
     `https://cloud.fanar.tech/org-slug/saml/callback`
